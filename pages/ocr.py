...
st.set_page_config(
    page_title="Nutrition Information OCR",
    page_icon=":apple:",
...
openai.api_key = "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"
...
def is_healthy_food(dictFood, weight, age):
    ...
    return (
        20 <= fat_percentage <= 35
        and 10 <= protein_percentage <= 35
        and sodium_lower <= sodium <= sodium_upper
    )


st.title("Nutrition Information OCR")
st.write(
    '<a class="caption blue-button" href=".." target="_self">← Back</a>',
...
with col1:
    ...
    weight = st.number_input(
        "Weight (in kg)", min_value=1.0, max_value=200.0, value=70.0, step=0.1
    )
...
if uploaded_file:
    ...
    if is_healthy_food(results, weight, age):
        ...
        st.warning(
            "This might not be the healthiest choice for you. Consider something lighter!"
        )
            ...
            try:
                response = openai.ChatCompletion.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "Act as my personal nutritional specialist.",
                        },
    ...
    with chat_container:
        ...
        user_input = st.text_input(
            "You are welcome to ask me for more healthy advice!:"
        )
                ...
                try:
                    response = openai.ChatCompletion.create(
                        ...
                        messages=[
                            {
                                "role": "system",
                                "content": "Act as my personal nutritional specialist and keep your output to 300 charachters. Rmemeber to alwasy be kind and ask me if I have anymore questions as you are here to help make a POSTIVE IMPACT ON MY LIFE!.",
                            },
...
st.write("---")
st.markdown(
    "For detailed nutritional guidelines, please refer to [Canada's Dietary Guidelines](https://www.canada.ca/en/health-canada/services/food-nutrition/healthy-eating/dietary-reference-intakes/tables/reference-values-macronutrients-dietary-reference-intakes-tables-2005.html)"
)
